...
if __name__ == "__main__":
    input_tensor = torch.randn(16, 64, 32, 32)  # (B, N, H, W)
    gam = GAM(in_channels=64)
    output_tensor = gam(input_tensor)
    print(output_tensor.shape)  # 输出: torch.Size([16, 64, 32, 32])